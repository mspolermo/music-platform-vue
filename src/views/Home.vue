  ...
  <main>
    ...
    <section class="mb-8 py-20 text-white text-center relative">
      ...
      <div class="container mx-auto">
        <div class="text-white main-header-content">
          ...
          <p class="w-full md:w-8/12 mx-auto">{{ $t('home.text') }}</p>
        </div>
      </div>
    ...
    <section class="container mx-auto">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        <!--        <div class="px-6 pt-6 pb-5 font-bold border-b border-gray-200" v-icon.right.yellow="'headphones-alt'"> </div>-->
        <div
          class="px-6 pt-6 pb-5 font-bold border-b border-gray-200"
          v-icon.right.yellow="'headphones-alt'"
        >
          <span class="card-title">{{ $t('home.songs') }}</span>
          <!-- Icon from directive here-->
        </div>
        <!-- Playlist -->
        <ol id="playlist">
